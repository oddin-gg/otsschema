...
func (x *TicketCancelRequest) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *TicketCancelResponse) GetCancelRejectionReason() CancelRejectionReason {
	...
	return CancelRejectionReason_NOT_KNOWN
}
...
var file_ots_ticket_cancel_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x42, 0x2d, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x64, 0x64, 0x69,
