...
_OTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=5,
    containing_service=None,
    input_type=ots_dot_ticket__result__pb2._TICKETRESULTREQUEST,
    output_type=ots_dot_ticket__result__pb2._TICKETRESULTRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Bettors',
    full_name='ots.ots.Bettors',
    index=7,
    containing_service=None,
    input_type=ots_dot_bettor__pb2._BETTORSREQUEST,
    output_type=ots_dot_bettor__pb2._BETTORSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
