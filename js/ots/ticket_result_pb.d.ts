...
export class TicketResultState extends jspb.Message {
  ...
  getObbSubSelectionInfoMap(): jspb.Map<string, TicketResultStateSelectionInfo>;
  clearObbSubSelectionInfoMap(): void;
...
export namespace TicketResultState {
  export type AsObject = {
    ...
    obbSubSelectionInfoMap: Array<[string, TicketResultStateSelectionInfo.AsObject]>,
    exchangeRate: number,
