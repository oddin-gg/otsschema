...
obbSubSelectionInfoMap: (f = msg.getObbSubSelectionInfoMap()) ? f.toObject(includeInstance, proto.ots.TicketResultStateSelectionInfo.toObject) : [],
...
proto.ots.TicketResultState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 10:
      var value = msg.getObbSubSelectionInfoMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.ots.TicketResultStateSelectionInfo.deserializeBinaryFromReader, "", new proto.ots.TicketResultStateSelectionInfo());
         });
      break;
...
proto.ots.TicketResultState.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getObbSubSelectionInfoMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(10, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.ots.TicketResultStateSelectionInfo.serializeBinaryToWriter);
  }
 ...
 * @return {!jspb.Map<string,!proto.ots.TicketResultStateSelectionInfo>}
 */
proto.ots.TicketResultState.prototype.getObbSubSelectionInfoMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.ots.TicketResultStateSelectionInfo>} */ (
 ...
 * @return {!proto.ots.TicketResultState} returns this
 */
proto.ots.TicketResultState.prototype.clearObbSubSelectionInfoMap = function() {
  this.getObbSubSelectionInfoMap().clear();
  return this;
};
